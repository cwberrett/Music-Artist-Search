...
/***/ function(module, exports) {
	...
	var artObj = {
	    ...
	    moreAlbums: function moreAlbums(change) {
	        if (change) {
	            this.albOffset += 10;
	    ...
	    displayArtist: function displayArtist() {
	        $("#artist .results").hide();
	        $("#artist .rowData").show();
	...
	var albObj = {
	    ...
	    displayAlbum: function displayAlbum() {
	        $("#album .results").hide();
	        $("#album .rowData").show();
	...
	var songObj = {
	    ...
	    displaySong: function displaySong() {
	        $("#track .results").hide();
	        $("#track .rowData").show();
	...
	var searchObj = {
	    offset: 0,
	    getList: function getList(query, type) {
	        this.query = query;
	    ...
	    more: function more(change, type) {
	        if (change) {
	            this.offset += 10;
	    ...
	    displayList: function displayList(type) {
	        $("#" + type + " .rowData").hide();
	        $("#" + type + " .results").show();
	        $(".results ul").empty();
	        var listName = type + 's';
...
/***/ }
/******/ ]);
//# sourceMappingURL=music-artist-search.1.0.0.js.map